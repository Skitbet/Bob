...
client.on('message', (message) => {
  ...
  var embed = new MessageEmbed()
    ...
    .addField("Message Content (DO NOT CLICK):", "||`" + message.content + "`||", false)
  
  
    var warnEmbed = new MessageEmbed()
    .setColor("RED")
    .setTitle("🚨 Detected a suspicious message! 🚨")
    .setDescription(message.author.username + "#" + message.author.discriminator + " has sent a suspicious message that flagged as a scam. If you clicked it please change your password immediately!")
